...
export function bodyCost(bodyparts: BodyPartConstant[]): number {
	...
	/*  计算最大的body，从该房间中生成
	 * 受限制于maxRepeats*/
export function generateBody(availableEnergy: number,bodyparts: BodyPartConstant[],sizeLimit:number): BodyPartConstant[] {
    let body: BodyPartConstant[] = [];
	let numRepeats:number = Math.min(Math.floor(availableEnergy / bodyCost(bodyparts)), Math.floor(MAX_CREEP_SIZE / bodyparts.length), sizeLimit);
	// 构建body
...
export const bodyConfigs: BodyConfigs = {
     ...
     * 基础治疗单位
     */
    healerx: getBodyConfig(
        { [TOUGH]:5, [MOVE]: 7, [HEAL]: 5 ,[ATTACK]:1 },
        { [TOUGH]:5, [MOVE]: 7, [HEAL]: 5 ,[ATTACK]:1 },
        { [TOUGH]:5, [MOVE]: 7, [HEAL]: 5 ,[ATTACK]:1 },
        { [TOUGH]:5, [MOVE]: 7, [HEAL]: 5 ,[ATTACK]:1 },
        { [TOUGH]:5, [MOVE]: 7, [HEAL]: 5 ,[ATTACK]:1 },
        { [MOVE]: 7, [HEAL]: 7 ,[ATTACK]:1},
        { [MOVE]: 16, [HEAL]: 16 ,[ATTACK]:1},
        { [MOVE]: 25, [HEAL]: 25 ,[ATTACK]:1}
    ),
 ...
 */
 /*
export const baseLayoutbf: BaseLayoutbf = {
    1: {
        [STRUCTURE_SPAWN]: [[-3,-2]]
    },
    2: {
...
export const baseLayout: BaseLayout = {
    ...
    2: {
        [STRUCTURE_EXTENSION]: [[-3,-1],[-1,-3],[-3,-2],[-2,-3],[-4,-2]]
    },
    3: {
        [STRUCTURE_EXTENSION]: [[-3,-3],[-2,-4],[-4,-3],[-3,-4],[1,-3]],
        [STRUCTURE_TOWER]: [[0,-1]],
        [STRUCTURE_ROAD]: [[0,-3],[-1,-2],[-2,-1],[-3,0],[-4,-1],[-5,-2],[-5,-3],[-4,-4],[-3,-5],[-2,-5],[-1,-4],[1,-4],[2,-5],[3,-5],[4,-4],[5,-3],[5,-2],[4,-1],[3,0],[2,-1],[1,-2]]
    },
    4: {
    ...
    7: {
        [STRUCTURE_EXTENSION]: [[4,0],[5,0],[5,1],[0,4],[1,5],[0,5],[-1,5],[-4,5],[-5,4],[-5,5]],
        [STRUCTURE_TOWER]: [[0,1]],
        [STRUCTURE_SPAWN]: [[-2,0]],
    ...
    8: {
        [STRUCTURE_TOWER]: [[-2,-2],[2,-2],[-2,2]],
        [STRUCTURE_LAB]: [[3,5],[4,5],[5,4],[5,3]],
        [STRUCTURE_SPAWN]: [[2,0]],
        [STRUCTURE_OBSERVER]: [[0,-4]],
        [STRUCTURE_NUKER]: [[0,-5]],
        [STRUCTURE_POWER_SPAWN]: [[0,2]],
        [STRUCTURE_RAMPART]: [[-2,-2],[2,-2],[-2,2],[3,5],[4,5],[5,4],[5,3],[2,0],[0,-4],[0,-5],[0,2]]
    }
}
 ...
 */
export const minerHervesteLimit = 250000
