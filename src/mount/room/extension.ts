...
export default class RoomExtension extends RoomShortcut {
     ...
     * 查找房间中的有效能量来源
     */
    public getAvailableSource(): StructureTerminal | StructureStorage | StructureContainer | Source | Ruin {
    ...
    public startWar(boostType: BoostType): OK | ERR_NAME_EXISTS | ERR_NOT_FOUND | ERR_INVALID_TARGET {
        ...
        // 获取执行强化的 lab
        const labs = boostFlag.pos.findInRange<StructureLab>(FIND_STRUCTURES, 2, {
    ...
    public linit(): string {
        ...
        */
       const lab1Flag = Game.flags[this.name+'lab1']
       const lab2Flag = Game.flags[this.name+'lab2']
